...
import {getSSLHubRpcClient, HubEvent, HubEventType, HubRpcClient} from '@farcaster/hub-nodejs';
...
(async () => {
    ...
    const subResult = await client.subscribe({
        eventTypes: [HubEventType.MERGE_ID_REGISTRY_EVENT, HubEventType.MERGE_NAME_REGISTRY_EVENT, HubEventType.MERGE_MESSAGE, HubEventType.PRUNE_MESSAGE, HubEventType.REVOKE_MESSAGE,]
    });
